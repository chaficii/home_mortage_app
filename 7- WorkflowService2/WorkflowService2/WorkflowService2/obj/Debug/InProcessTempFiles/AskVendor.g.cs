...
namespace WorkflowService2 {
    ...
    public partial class AskVendor : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<System.Uri> _serviceUri;
        
        private System.Activities.OutArgument<int> _interestRate;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<System.Uri> serviceUri {
            get {
        ...
        public System.Activities.OutArgument<int> interestRate {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AskVendor).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AskVendor));
        ...
        private string FindResource() {
            string[] resources = typeof(AskVendor).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AskVendor.g.xaml") || resource.Equals("AskVendor.g.xaml"))) {
                    return resource;
                }
            }
