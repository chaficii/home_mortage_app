...
namespace WorkflowService2 {
    ...
    public partial class AskMyVendor : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AskMyVendor).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AskMyVendor));
        ...
        private string FindResource() {
            string[] resources = typeof(AskMyVendor).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AskMyVendor.g.xaml") || resource.Equals("AskMyVendor.g.xaml"))) {
                    return resource;
                }
            }
